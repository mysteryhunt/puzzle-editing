...
<?php
	...
	displayQueue($uid, $testPuzzles, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE);
	
	echo '<br />';
	
	echo '<h3>Finished Testing</h3>';
	$donePuzzles = getActiveDoneTestingPuzzlesForUser($uid);
	displayQueue($uid, $donePuzzles, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE);
	
	echo '<br />';
	
	echo '<h3>Puzzles Not Currently In Testing</h3>';
	$inactivePuzzles = getInactiveTestPuzzlesForUser($uid);
	displayQueue($uid, $inactivePuzzles, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, TRUE);
